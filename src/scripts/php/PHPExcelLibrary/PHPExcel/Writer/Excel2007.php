...
class PHPExcel_Writer_Excel2007 extends PHPExcel_Writer_Abstract implements PHPExcel_Writer_IWriter
{
    ...
    public function save($pFilename = null)
    {
        if ($this->spreadSheet !== null) {
            ...
            throw new PHPExcel_Writer_Exception("PHPExcelClasses object unassigned.");
        }
    }

    /**
     * Get PHPExcelClasses object
     *
     * @return PHPExcel
     * @throws PHPExcel_Writer_Exception
     */
    public function getPHPExcel()
    {
        if ($this->spreadSheet !== null) {
            ...
            throw new PHPExcel_Writer_Exception("No PHPExcelClasses object assigned.");
        }
    }
