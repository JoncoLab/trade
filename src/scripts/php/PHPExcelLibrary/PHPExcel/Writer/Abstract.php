...
abstract class PHPExcel_Writer_Abstract implements PHPExcel_Writer_IWriter
{
     ...
     * Identifies whether the Writer should write definitions for any charts that exist in the PHPExcelClasses object;
     *
     * @var    boolean
     */
     ...
     * Forces PHPExcelClasses to recalculate all formulae in a workbook when saving, so that the pre-calculated values are
     ...
     *        Set to true, to advise the Writer to include any charts that exist in the PHPExcelClasses object.
     ...
     *     If false, then formulae are not calculated on save. This is faster for saving in PHPExcelClasses, but slower
