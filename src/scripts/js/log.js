                ...
                $.ajax({
                        ...
                        switch (data) {
                            ...
                            default:
                                $('main').empty().html(
                                    ...
                                    '<br>Спробуйте <a href="../../log.php">Перезавантажити сторінку.</a>' +
                    ...
                    error: function (xhr, text, description) {
                        $('main').empty().html(
                            ...
                            'Спробуйте <a href="../../log.php">Перезавантажити сторінку.</a><br>Якщо проблема не зникне, зверніться, будь ласка, до адміністрації сайту.</p>'
                        );
                    }
                });
            },
