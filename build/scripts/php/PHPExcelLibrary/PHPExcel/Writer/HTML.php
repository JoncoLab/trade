...
class PHPExcel_Writer_HTML extends PHPExcel_Writer_Abstract implements PHPExcel_Writer_IWriter
{
     ...
     *
     * @param    PHPExcel    $phpExcel    PHPExcelClasses object
     */
    ...
    {
        // PHPExcelClasses object known?
        if (is_null($this->phpExcel)) {
            throw new PHPExcel_Writer_Exception('Internal PHPExcelClasses object not set to an instance of an object.');
        }
        ...
        $html .= '<!-- Generated by PHPExcelClasses - http://www.phpexcel.net -->' . PHP_EOL;
        $html .= '<html>' . PHP_EOL;
        $html .= '  <head>' . PHP_EOL;
